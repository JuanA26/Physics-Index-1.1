...
int main()
{
   ...
   for (int i = 0; i < 10; i ++) {
    ...
    int Jsoal = 0;
    int Bfisik = 0;
    cout << "1. Solver Fisika" << endl; cout << "2. Konstanta Fisika" << endl;
            ...
            if (cin.fail()) {
                ...
                goto phy1;
                    ...
                    goto phy1;
                        ...
                        if(a == 0){
                            cout << "\n";
                            cout << "Panjang tinggi segitiga adalah : " << phy(a, b, c);
                            cout << "\n\n";
                            cout << "|_______________________________________________________________________|";
                            cout << "\n\n";
                            goto back;
                            ...
                            cout << "\n";
                            cout << "Panjang alas segitiga adalah : " << phy(a, b, c);
                            cout << "\n\n";
                            cout << "|_______________________________________________________________________|";
                            cout << "\n\n";
                            goto back;
                            ...
                            cout << "\n";
                            cout << "Panjang bidang miring segitiga adalah : " << phy(a, b, c);
                            cout << "\n\n";
                            cout << "|_______________________________________________________________________|";
                            cout << "\n\n";
                            goto back;
